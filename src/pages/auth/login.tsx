...
export default function Login() {
  ...
  const handleDemoLogin = (role: 'user' | 'admin') => {
    const demoCredentials = {
      user: { email: 'demo@bizoe.com', password: 'demo123' },
      admin: { email: 'admin@bizoe.com', password: 'admin123' }
    }
  ...
  return (
    <Layout
      seo={{
        title: '會員登入 - BIZOE',
        description: '登入您的BIZOE帳戶，享受專屬會員服務',
      }}
    >
          ...
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <div className="mt-1 relative">
                  <input
                    ...
                    placeholder={t('forms.placeholder_password')}
                  />
                  <button
                    type="button"
              ...
              <div>
                ...
                >
                  {isLoading ? t('messages.loading') : t('auth.login')}
                </button>
              </div>
            </form>
            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white text-gray-500">{t('auth.quick_demo')}</span>
                </div>
              </div>
            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white text-gray-500">{t('auth.login_with_social')}</span>
                </div>
              </div>
